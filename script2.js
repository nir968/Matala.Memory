...
var chosenCards = sessionStorage.getItem("numCards");

function duplicateArrayElements(arr) { 
    var duplicated = [];
 
    for (var i = 0; i < chosenCards / 2; i++) { 
...
const duplicatedImages = duplicateArrayElements(imgs); // (imgs, chosenCards)
...
var storedName = sessionStorage.getItem("nameDisplay") || "Guest"; // Use "Guest" as the default value if no name is stored
